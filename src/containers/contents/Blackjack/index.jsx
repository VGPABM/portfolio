      ...
      <div className="project__content">
        ...
        <div className="project__content__section">
          <div className="project__content__section__text">
            <p>
              This project is an Augmented Reality (AR) Blackjack game developed using Python Game, OpenCV and cNN machine learning. The game is designed to be played in an AR environment, allowing players to use real cards which was detected by using a webcam and these cards then will be shown on the computer screen.
              Player then could choose what decisions they want to take, such as hit, stand, double down, or split. The game is designed to be user-friendly and provides a fun AR gaming experience.
            </p>
          </div>
        ...
        <div className="project__content__youtube">
          <iframe
            width="100%"
            height="400"
            src={getYoutubeEmbedLink("https://www.youtube.com/watch?v=ffk5YHtLTUw")}
